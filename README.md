...
Hello! As part of the team at UMAI I made a collaborative filtering-based recommendation system for recipes using Funk SVD matrix factorization for the backend of our IOS app.
